...
var myproxySignerVersion = ":myproxy1"
...
func signHost(ca tls.Certificate, hosts []string) (cert *tls.Certificate, err error) {
	...
	template := x509.Certificate{
		SerialNumber: serial,
		Issuer:       x509ca.Issuer,
		Subject: pkix.Name{
			Organization: []string{"MyProxy untrusted MITM proxy Inc"},
		},
		NotBefore:             start,
		NotAfter:              end,
	...
	hash := hashSorted(append(hosts, myproxySignerVersion, ":"+runtime.Version()))
